...
// CODE HERE
const postTaxPrices = prices.map(number => number * 1.07);
...
// CODE HERE
const totalPopulation = populations.reduce((firstNum, secondNum) => firstNum + secondNum)
...
// CODE HERE
const myStrongest = monstersInYourPocket.filter((monster, CP) => monster.CP > 200)
